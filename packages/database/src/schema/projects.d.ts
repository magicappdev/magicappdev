...
export declare const PROJECT_STATUS: readonly ["draft", "active", "archived", "deployed"];
/** Project framework enum values */
export declare const PROJECT_FRAMEWORK: readonly ["react-native", "expo", "next", "remix"];
/** Projects table */
